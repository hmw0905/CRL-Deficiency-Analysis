...
ui <- fluidPage(
  ...
  titlePanel("CRL Deficiency Dashboard"),
      ...
      tabsetPanel(
        tabPanel(
          ...
          div(
            ...
            p("This dashboard summarizes Complete Response Letter (CRL) deficiency patterns across applications."),
            tags$ul(
              tags$li("Use the filters on the left to subset by application type, year, and deficiency domain."),
              tags$li("Overview shows domain-level composition."),
              tags$li("Subtype Explorer shows deficiency subtype composition."),
              tags$li("CRL Structure shows whether CRLs involve one or multiple domains."),
              tags$li("CMC Deep Dive isolates CMC-related patterns for closer review.")
            ),
            p(strong("Note:"), " Percentages update within the filtered subset.")
          ),
        ...
        tabPanel(
          ...
          div(
            class = "note-box",
            h4("CMC Deep Dive"),
            p("This tab focuses specifically on Chemistry, Manufacturing, and Controls (CMC) deficiencies using the currently selected application type and year filters.")
          ),
        ...
        tabPanel(
          ...
          div(
            ...
            tags$ul(
              ...
              tags$li("Subtype percentages are calculated within the displayed domain or facet."),
